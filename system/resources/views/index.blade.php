               ...
               <div class="container-fluid">
                  <div class="row d_flex">
                     ...
                     <div class="col-md-7 padding_right1">
                        <div class="text-img">
                           <figure><img src="{{url('public')}}/images/top_img.png" alt="#"/></figure>
                           <h3>01</h3>
                        </div>
                     </div>
                  </div>
               ...
               <div class="col-sm-12">
                  <div class="black_bg">
                     <div class="row">
                        ...
                        <div class="col-md-5">
                           <div class="mane_img">
                              <figure><img src="{{url('public')}}/images/mane_img.jpg" alt="#"/></figure>
                           </div>
                        </div>
                     </div>
                  </div>
                              ...
                              <div class="carousel-caption">
                                 <div class="row">
                                    <div  class="col-md-12">
                                       <div class="test_box">
                                          <h3>Michl ro</h3>
                                          <p><i class="padd_rightt0"><img src="{{url('public')}}/images/te1.png" alt="#"/></i>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some <i class="padd_leftt0"><img src="images/te2.png" alt="#"/></i> <br>form, by injected humour, or randomised words which don't look even slightly believable</p>
                                       </div>
                                    </div>
                                 </div>
                              </div>
            ...
            <div class="copyright">
               <div class="container">
                  <div class="row">
                     ...
                     <span>Copyright &copy; 2020 @if(date("Y") > '2020') - {{date("Y")}} @endif <a href="https://cekidot.com">Ria Kurniawati</a>.</span>All rights reserved
                     </div>
                  </div>
               </div>
            </div>
